...
## Task 13
Task 13 gives a string that seems to be made up of just weird characters of pluses and minuses. People who have been on the deepest parts of the internet may recognize this to be the language `brainfuck` which uses only 8 commands, a data pointer and an instruction pointer. The hint says binaryfuck, but I found that binaryfuck is like a subset of brainfuck and its decoder doesn't work quite as well. Googling up a brainfuck decoder and pasting this text in should give you the answer you need. If you want more information on brainfuck, you can find it [here](https://en.wikipedia.org/wiki/Brainfuck#:~:text=Brainfuck%20is%20an%20esoteric%20programming,pointer%20and%20an%20instruction%20pointer.).
## Task 14
